...
public class OrderReportFlowProductResidentialGutterDeliveryProductPickerScreen extends BasePage {
    ...
    public OrderReportFlowProductResidentialGutterDeliveryProductPickerScreen(IOSDriver driver) {
        super(driver);
