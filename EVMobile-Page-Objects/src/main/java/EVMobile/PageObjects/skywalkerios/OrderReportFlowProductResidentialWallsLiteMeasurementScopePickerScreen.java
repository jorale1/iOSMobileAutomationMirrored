...
public class OrderReportFlowProductResidentialWallsLiteMeasurementScopePickerScreen extends BasePage {
    ...
    public OrderReportFlowProductResidentialWallsLiteMeasurementScopePickerScreen(IOSDriver driver) {
        super(driver);
